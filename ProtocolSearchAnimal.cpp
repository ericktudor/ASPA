...
string ProtocolSearchAnimal::handleMessage(string msg)
{
        ...
        else 
        {
            ...
            while (SQLFetch(SQLStatementHandle) == SQL_SUCCESS)
            {
                ...
                if (ok_age == 1 && ok_location == 1 && ok_sex == 1 && ok_size == 1 && ok_species == 1)
                {
                    ...
                    //this->msg = this->msg + "2/1/2/Mascul/Palady/Mica/Hamster/2/1/Mascul/Palady/Medie/Pisica/";
                    //break;
                }
	...
	{
		cout << "A fost gasit un animal cu caracteristicile dorite!";
		this->msg = "2/1/2/Mascul/Palady/Mica/Hamster/2/1/Mascul/Palady/Medie/Pisica/";
	}
	else
	{
